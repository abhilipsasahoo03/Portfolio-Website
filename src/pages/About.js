        ...
        <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center" id="aboutcont">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div className="flex justify-center">
              ...
              >
               <p className="bg-white text-2xl font-extrabold inline-block text-transparent bg-clip-text" id="workwithme"> Work With Me </p>
              </a>
              <a
                href="#projects"
              ...
              >
               <p className="text-2xl font-extrabold inline-block bg-white text-transparent bg-clip-text" id="seemywork"> See My Past Work </p>
              </a>
            </div>
          </div>
